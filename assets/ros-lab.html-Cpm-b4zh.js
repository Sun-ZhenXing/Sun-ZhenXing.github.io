import{_ as u}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as l,o as r,c as d,b as n,d as s,a as e,w as a,e as c}from"./app-DhX54nll.js";const k={},m=n("p",null,"ROS 实验内容。",-1),_={class:"hint-container info"},g=n("p",{class:"hint-container-title"},"说明",-1),v=n("a",{href:"https://gitee.com/sun-zhenxing/ros-lab",target:"_blank",rel:"noopener noreferrer"},"Gitee",-1),b=c(`<h2 id="1-自定义话题通信" tabindex="-1"><a class="header-anchor" href="#1-自定义话题通信"><span>1. 自定义话题通信</span></a></h2><p>创建一个名为 <code>learning01_ws</code> 的工作空间：</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">mkdir</span> <span class="token parameter variable">-p</span> learning01_ws/src
...
<span class="token function">catkin_install_python</span><span class="token punctuation">(</span>PROGRAMS scripts/demo04_sub_person_p.py
  DESTINATION <span class="token punctuation">\${</span>CATKIN_PACKAGE_BIN_DESTINATION<span class="token punctuation">}</span>
<span class="token punctuation">)</span>
</code></pre></div><p>然后按 <code>Ctrl + Shift + B</code>，再次执行编译。编译成功后可测试。</p><p>下面创建三个终端，执行测试：</p>`,24),y=n("div",{class:"language-bash","data-ext":"sh","data-title":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token comment"},"# 启动 ROS 核心进程，只需要启动一次"),s(`
roscore
`)])])],-1),h=n("div",{class:"language-bash","data-ext":"sh","data-title":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token builtin class-name"},"source"),s(` ./devel/setup.bash
...
`)])])],-1),f=c(`<p>使用下面的命令用于可视化查看当前 ROS 通信的逻辑图：</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>rqt_graph
...
<span class="token function">catkin_install_python</span><span class="token punctuation">(</span>PROGRAMS scripts/demo03_param_del_p.py
  DESTINATION <span class="token punctuation">\${</span>CATKIN_PACKAGE_BIN_DESTINATION<span class="token punctuation">}</span>
<span class="token punctuation">)</span>
</code></pre></div><p>现在构建，确保没有错误即可运行。</p><p>利用 <code>rosparam list</code> 命令查看所有参数，利用 <code>rosparam get &lt;param&gt;</code> 命令获取指定参数。</p><p>下面创建三个终端，执行测试：</p>`,16),I=n("div",{class:"language-bash","data-ext":"sh","data-title":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token comment"},"# 启动 ROS 核心进程，只需要启动一次"),s(`
roscore
`)])])],-1),w=n("div",{class:"language-bash","data-ext":"sh","data-title":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token builtin class-name"},"source"),s(` ./devel/setup.bash
...
`)])])],-1);function P(R,C){const i=l("RouteLink"),o=l("CodeTabs");return r(),d("div",null,[m,n("div",_,[g,n("p",null,[s("本文的源代码在 "),v,s(" 上保存，在进行本文实验时需要确保安装了 "),e(i,{to:"/posts/envs/ros-env.html"},{default:a(()=>[s("ROS 环境安装")]),_:1}),s(" 一文中的指定环境。")])]),b,e(o,{id:"77",data:[{id:"终端 1"},{id:"终端 2"},{id:"终端 3"}]},{title0:a(({value:t,isActive:p})=>[s("终端 1")]),title1:a(({value:t,isActive:p})=>[s("终端 2")]),title2:a(({value:t,isActive:p})=>[s("终端 3")]),tab0:a(({value:t,isActive:p})=>[y]),tab1:a(({value:t,isActive:p})=>[h]),tab2:a(({value:t,isActive:p})=>[x]),_:1}),f,e(o,{id:"155",data:[{id:"终端 1"},{id:"终端 2"},{id:"终端 3"}]},{title0:a(({value:t,isActive:p})=>[s("终端 1")]),title1:a(({value:t,isActive:p})=>[s("终端 2")]),title2:a(({value:t,isActive:p})=>[s("终端 3")]),tab0:a(({value:t,isActive:p})=>[A]),tab1:a(({value:t,isActive:p})=>[N]),tab2:a(({value:t,isActive:p})=>[S]),_:1}),T,e(o,{id:"204",data:[{id:"终端 1"},{id:"终端 2"}]},{title0:a(({value:t,isActive:p})=>[s("终端 1")]),title1:a(({value:t,isActive:p})=>[s("终端 2")]),tab0:a(({value:t,isActive:p})=>[I]),tab1:a(({value:t,isActive:p})=>[w]),_:1})])}const M=u(k,[["render",P],["__file","ros-lab.html.vue"]]),D=JSON.parse('{"path":"/posts/envs/ros-lab.html","title":"进行 ROS 实验","lang":"zh-CN","frontmatter":{"title":"进行 ROS 实验","date":"2023-03-21T00:00:00.000Z","category":["环境搭建"],"tag":["ROS"],"description":"ROS 实验内容。","head":[["meta",{"property":"og:url","content":"https://blog.alexsun.top/posts/envs/ros-lab.html"}],["meta",{"property":"og:site_name","content":"鸭梨"}],["meta",{"property":"og:title","content":"进行 ROS 实验"}],["meta",{"property":"og:description","content":"ROS 实验内容。"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-03-02T16:16:12.000Z"}],["meta",{"property":"article:author","content":"Alex Sun"}],["meta",{"property":"article:tag","content":"ROS"}],["meta",{"property":"article:published_time","content":"2023-03-21T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-03-02T16:16:12.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"进行 ROS 实验\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2023-03-21T00:00:00.000Z\\",\\"dateModified\\":\\"2024-03-02T16:16:12.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Alex Sun\\",\\"url\\":\\"https://blog.alexsun.top/\\"}]}"]]},"headers":[{"level":2,"title":"1. 自定义话题通信","slug":"1-自定义话题通信","link":"#1-自定义话题通信","children":[]},{"level":2,"title":"2. 服务通信","slug":"2-服务通信","link":"#2-服务通信","children":[]},{"level":2,"title":"3. 参数服务器","slug":"3-参数服务器","link":"#3-参数服务器","children":[]}],"git":{"createdTime":1679383092000,"updatedTime":1709396172000,"contributors":[{"name":"Sun-ZhenXing","email":"1006925066@qq.com","commits":6}]},"readingTime":{"minutes":4.21,"words":1262},"filePathRelative":"posts/envs/ros-lab.md","localizedDate":"2023年3月21日","excerpt":"<p>ROS 实验内容。</p>\\n","autoDesc":true}');export{M as comp,D as data};
