import{_ as r,X as u,Y as d,Z as v,a0 as s,$ as a,a2 as e,a1 as n,a3 as p,C as t}from"./framework-4507c9ea.js";const k={},m=s("p",null,"从零开始使用 Naive UI 的步骤。",-1),g={class:"table-of-contents"},b=s("h2",{id:"_1-naive-ui",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#_1-naive-ui","aria-hidden":"true"},"#"),n(" 1. Naive UI")],-1),_={href:"https://www.naiveui.com/zh-CN/",target:"_blank",rel:"noopener noreferrer"},h=s("h2",{id:"_2-项目准备",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#_2-项目准备","aria-hidden":"true"},"#"),n(" 2. 项目准备")],-1),f=p(`<p>现在可以开始安装 Naive UI 了，输入下面的命令开始安装：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">pnpm</span> <span class="token function">add</span> <span class="token parameter variable">-D</span> naive-ui
</code></pre></div>`,2),y=s("code",null,"vfonts",-1),x=p(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">pnpm</span> <span class="token function">add</span> <span class="token parameter variable">-D</span> vfonts
</code></pre></div>`,1),w=s("code",null,"@vicons/ionicons5",-1),N=p(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">pnpm</span> <span class="token function">add</span> <span class="token parameter variable">-D</span> @vicons/ionicons5
</code></pre></div>`,1),I={href:"https://xicons.org/",target:"_blank",rel:"noopener noreferrer"},V=p(`<h2 id="_3-配置自动导入" tabindex="-1"><a class="header-anchor" href="#_3-配置自动导入" aria-hidden="true">#</a> 3. 配置自动导入</h2><p>安装 Vite 自动导入插件：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">pnpm</span> <span class="token function">add</span> <span class="token parameter variable">-D</span> unplugin-auto-import
...
</code></pre></div>`,7);function C(U,B){const o=t("router-link"),c=t("ExternalLinkIcon"),l=t("RouterLink"),i=t("Badge");return u(),d("div",null,[m,v(" more "),s("nav",g,[s("ul",null,[s("li",null,[a(o,{to:"#_1-naive-ui"},{default:e(()=>[n("1. Naive UI")]),_:1})]),s("li",null,[a(o,{to:"#_2-项目准备"},{default:e(()=>[n("2. 项目准备")]),_:1})]),s("li",null,[a(o,{to:"#_3-配置自动导入"},{default:e(()=>[n("3. 配置自动导入")]),_:1})])])]),b,s("p",null,[s("a",_,[n("Naive UI"),a(c)]),n(" 是 Vue3 官方推荐的一款 UI 库，其功能覆盖全面、界面统一简洁，适合不同需求的开发者使用。")]),h,s("p",null,[n("文本使用的项目模板是 "),a(l,{to:"/posts/frontend/vue/create-vite-app.html"},{default:e(()=>[n("创建 Vite 应用")]),_:1}),n(" 一文中的模板，使用 Vue3 + Vite3 + TypeScript。")]),f,s("p",null,[a(i,{type:"tip",vertical:"inherit"},{default:e(()=>[n("可选")]),_:1}),n(" 如果需要配套的字体，安装 "),y,n("：")]),x,s("p",null,[a(i,{type:"tip",vertical:"inherit"},{default:e(()=>[n("可选")]),_:1}),n(),a(i,{type:"warning"},{default:e(()=>[n("推荐")]),_:1}),n(" 如果需要配套的图标，安装 "),w,n("：")]),N,s("p",null,[n("要选用图标，可以查看 "),s("a",I,[n("xicons"),a(c)]),n(" 网站上的示例，可以搜索哦！")]),V])}const L=r(k,[["render",C],["__file","use-naive-ui.html.vue"]]);export{L as default};
