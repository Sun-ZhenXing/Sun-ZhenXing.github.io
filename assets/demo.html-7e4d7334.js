import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o,c as p,a as c,e as n,f as a,d as l,b as i}from"./app-32f6cd01.js";const u={},r=n("p",null,"使用 VuePress 编写博客的一些配置和示例。",-1),d=i(`<h1 id="博客编写示例" tabindex="-1"><a class="header-anchor" href="#博客编写示例" aria-hidden="true">#</a> 博客编写示例</h1><h2 id="文章结构" tabindex="-1"><a class="header-anchor" href="#文章结构" aria-hidden="true">#</a> 文章结构</h2><p>每个 MarkDown 文件都由这几部分构成：</p><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code><span class="token front-matter-block"><span class="token punctuation">---</span>
...
</code></pre></div>`,17),k=n("em",null,"徽章文字",-1);function m(v,b){const s=t("Badge");return o(),p("div",null,[r,c(" more "),d,n("blockquote",null,[n("p",null,[a("文字结尾应该有深蓝色的 "),k,a(" 徽章 "),l(s,{text:"徽章文字"}),a("。")])])])}const y=e(u,[["render",m],["__file","demo.html.vue"]]);export{y as default};
