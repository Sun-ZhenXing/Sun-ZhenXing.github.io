import{_ as r}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as k,c as v,a as m,d as n,e as s,b as o,w as a,f as l}from"./app-0718dc96.js";const b={},_=n("p",null,"ROS 实验内容。",-1),g={class:"hint-container info"},y=n("p",{class:"hint-container-title"},"说明",-1),h={href:"https://gitee.com/sun-zhenxing/ros-lab",target:"_blank",rel:"noopener noreferrer"},f=l(`<h2 id="_1-自定义话题通信" tabindex="-1"><a class="header-anchor" href="#_1-自定义话题通信" aria-hidden="true">#</a> 1. 自定义话题通信</h2><p>创建一个名为 <code>learning01_ws</code> 的工作空间：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">mkdir</span> <span class="token parameter variable">-p</span> learning01_ws/src
...
</code></pre></div><p><code>demo03_pub_person_p.py</code> 文件的内容是：</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">#!/usr/bin/env python3</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>现在，编辑 <code>plumbing_pub_sub/CMakeLists.txt</code>，在下方添加下面的代码：</p><div class="language-cmake" data-ext="cmake"><pre class="language-cmake"><code><span class="token function">catkin_install_python</span><span class="token punctuation">(</span>PROGRAMS scripts/demo03_pub_person_p.py
...
`)])])],-1),I=l(`<p>使用下面的命令用于可视化查看当前 ROS 通信的逻辑图：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>rqt_graph
</code></pre></div><p>如果两个终端都分别看到消息表明成功。</p><h2 id="_2-服务通信" tabindex="-1"><a class="header-anchor" href="#_2-服务通信" aria-hidden="true">#</a> 2. 服务通信</h2><p>创建功能包名为 <code>plumbing_server_client</code> 并添加相关依赖：</p><ol><li>在 VS Code 中按 <code>Ctrl + Shift + P</code> 使用命令面板，输入 <code>ROS: Create Catkin Package</code> 回车</li><li>接着输入包名 <code>plumbing_server_client</code></li><li>输入依赖项 <code>roscpp rospy std_msgs</code></li></ol><p>在功能包下创建 <code>scripts</code> 文件夹和 <code>srv</code> 文件夹，创建文件 <code>srv/Multiply.srv</code>，其内容为：</p><div class="language-go" data-ext="go"><pre class="language-go"><code># 客户端请求时发送的两个数字
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>加入下面的代码到 <code>CMakeLists.txt</code>：</p><div class="language-cmake" data-ext="cmake"><pre class="language-cmake"><code><span class="token function">catkin_install_python</span><span class="token punctuation">(</span>PROGRAMS scripts/demo01_server_p.py
  DESTINATION <span class="token punctuation">\${</span>CATKIN_PACKAGE_BIN_DESTINATION<span class="token punctuation">}</span>
<span class="token punctuation">)</span>
...
</code></pre></div><p>现在执行构建，步骤和上述构建步骤一致，确保构建成功。</p><p>下面创建三个终端，执行测试：</p>`,23),S=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token comment"},"# 启动 ROS 核心进程，只需要启动一次"),s(`
roscore
...
`)])])],-1),C=l(`<p>终端 3 用于计算两个数的乘积，需要在命令行指定这两个数字。</p><h2 id="_3-参数服务器" tabindex="-1"><a class="header-anchor" href="#_3-参数服务器" aria-hidden="true">#</a> 3. 参数服务器</h2><p>创建功能包名为 <code>plumbing_param_server</code> 并添加相关依赖。</p><p>创建文件 <code>plumbing_param_server/scripts/demo01_param_set_p.py</code>，内容为：</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">#!/usr/bin/env python3</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>创建 <code>demo02_param_get_p.py</code> 文件，内容为：</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">#!/usr/bin/env python3</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>创建 <code>demo03_param_del_p.py</code>，内容为：</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">#!/usr/bin/env python3</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>添加可执行权限：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">chmod</span> +x src/plumbing_param_server/scripts/*.py
</code></pre></div><p>在 <code>CMakeLists.txt</code> 中加入下面的代码：</p><div class="language-cmake line-numbers-mode" data-ext="cmake"><pre class="language-cmake"><code><span class="token function">catkin_install_python</span><span class="token punctuation">(</span>PROGRAMS scripts/demo01_param_set_p.py
  DESTINATION <span class="token punctuation">\${</span>CATKIN_PACKAGE_BIN_DESTINATION<span class="token punctuation">}</span>
<span class="token punctuation">)</span>
...
<span class="token function">catkin_install_python</span><span class="token punctuation">(</span>PROGRAMS scripts/demo03_param_del_p.py
  DESTINATION <span class="token punctuation">\${</span>CATKIN_PACKAGE_BIN_DESTINATION<span class="token punctuation">}</span>
<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>现在构建，确保没有错误即可运行。</p><p>利用 <code>rosparam list</code> 命令查看所有参数，利用 <code>rosparam get &lt;param&gt;</code> 命令获取指定参数。</p><p>下面创建三个终端，执行测试：</p>`,16),P=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token comment"},"# 启动 ROS 核心进程，只需要启动一次"),s(`
roscore
`)])])],-1),T=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token builtin class-name"},"source"),s(` ./devel/setup.bash
...
`)])])],-1);function R(O,M){const u=i("ExternalLinkIcon"),d=i("RouterLink"),c=i("CodeTabs");return k(),v("div",null,[_,m(" more "),n("div",g,[y,n("p",null,[s("本文的源代码在 "),n("a",h,[s("Gitee"),o(u)]),s(" 上保存，在进行本文实验时需要确保安装了 "),o(d,{to:"/posts/envs/ros-env.html"},{default:a(()=>[s("ROS 环境安装")]),_:1}),s(" 一文中的指定环境。")])]),f,o(c,{id:"77",data:[{title:"终端 1"},{title:"终端 2"},{title:"终端 3"}]},{tab0:a(({title:e,value:p,isActive:t})=>[x]),tab1:a(({title:e,value:p,isActive:t})=>[N]),tab2:a(({title:e,value:p,isActive:t})=>[A]),_:1}),I,o(c,{id:"155",data:[{title:"终端 1"},{title:"终端 2"},{title:"终端 3"}]},{tab0:a(({title:e,value:p,isActive:t})=>[S]),tab1:a(({title:e,value:p,isActive:t})=>[w]),tab2:a(({title:e,value:p,isActive:t})=>[E]),_:1}),C,o(c,{id:"204",data:[{title:"终端 1"},{title:"终端 2"}]},{tab0:a(({title:e,value:p,isActive:t})=>[P]),tab1:a(({title:e,value:p,isActive:t})=>[T]),_:1})])}const K=r(b,[["render",R],["__file","ros-lab.html.vue"]]);export{K as default};
