import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as t,o,c as p,a,d as n,b as l,e as c}from"./app-C6k5k7Rq.js";const r={},i=c(`<h1 id="博客编写示例" tabindex="-1"><a class="header-anchor" href="#博客编写示例"><span>博客编写示例</span></a></h1><p>使用 VuePress 编写博客的一些配置和示例。</p><h2 id="文章结构" tabindex="-1"><a class="header-anchor" href="#文章结构"><span>文章结构</span></a></h2><p>每个 MarkDown 文件都由这几部分构成：</p><div class="language-markdown" data-ext="md" data-title="md"><pre class="language-markdown"><code><span class="token front-matter-block"><span class="token punctuation">---</span>
