...
`)])])],-1),C=l(`<p>使用下面的命令用于可视化查看当前 ROS 通信的逻辑图：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>rqt_graph
...
</code></pre></div><p>现在执行构建，步骤和上述构建步骤一致，确保构建成功。</p><p>下面创建三个终端，执行测试：</p>`,23),A=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token comment"},"# 启动 ROS 核心进程，只需要启动一次"),s(`
roscore
...
rosrun plumbing_server_client mul_cli.py `),n("span",{class:"token number"},"3"),s(),n("span",{class:"token number"},"4"),s(`
`)])])],-1),I=n("p",null,"终端 3 用于计算两个数的乘积，需要在命令行指定这两个数字。",-1);function P(R,T){const u=c("ExternalLinkIcon"),d=c("RouterLink"),i=c("CodeTabs");return k(),v("div",null,[g,m(" more "),n("div",_,[y,n("p",null,[s("本文的源代码在 "),n("a",h,[s("Gitee"),o(u)]),s(" 上保存，在进行本文实验时需要确保安装了 "),o(d,{to:"/posts/envs/ros-env.html"},{default:a(()=>[s("ROS 环境安装")]),_:1}),s(" 一文中的指定环境。")])]),f,o(i,{id:"77",data:[{title:"终端 1"},{title:"终端 2"},{title:"终端 3"}]},{tab0:a(({title:e,value:p,isActive:t})=>[x]),tab1:a(({title:e,value:p,isActive:t})=>[N]),tab2:a(({title:e,value:p,isActive:t})=>[S]),_:1}),C,o(i,{id:"155",data:[{title:"终端 1"},{title:"终端 2"},{title:"终端 3"}]},{tab0:a(({title:e,value:p,isActive:t})=>[A]),tab1:a(({title:e,value:p,isActive:t})=>[E]),tab2:a(({title:e,value:p,isActive:t})=>[w]),_:1}),I])}const q=r(b,[["render",P],["__file","ros-lab.html.vue"]]);export{q as default};
