import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as e,o,c,a as l,e as s,f as n,d as u,b as a}from"./app-32f6cd01.js";const i={},r=s("p",null,"VuePress2 的使用指南。",-1),k=a(`<h2 id="1-将一篇-markdown-文章视为-vue-sfc" tabindex="-1"><a class="header-anchor" href="#1-将一篇-markdown-文章视为-vue-sfc" aria-hidden="true">#</a> 1. 将一篇 MarkDown 文章视为 Vue SFC</h2><p>每一个 MarkDown 文章都会被编译为 Vue SFC（单文件组件），因此可以借助 TypeScript 直接编写动态网页。</p><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code>---
title: 测试
date: 2023-01-03
---
...
</code></pre></div><h2 id="3-使用-webpack-打包" tabindex="-1"><a class="header-anchor" href="#3-使用-webpack-打包" aria-hidden="true">#</a> 3. 使用 Webpack 打包</h2><p>VuePress 支持使用 Webpack 打包，依赖示例如下：</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
