...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,17),m=n("em",null,"徽章文字",-1);function v(k,b){const s=p("Badge");return t(),l("div",null,[u,i(" more "),r,n("blockquote",null,[n("p",null,[a("文字结尾应该有深蓝色的 "),m,a(" 徽章 "),c(s,{text:"徽章文字"}),a("。")])])])}const g=e(d,[["render",v],["__file","demo.html.vue"]]);export{g as default};
