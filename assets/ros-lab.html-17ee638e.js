...
`)])])],-1);function R(O,M){const u=i("ExternalLinkIcon"),d=i("RouterLink"),c=i("CodeTabs");return k(),v("div",null,[_,m(" more "),n("div",g,[y,n("p",null,[s("本文的源代码在 "),n("a",h,[s("Gitee"),o(u)]),s(" 上保存，在进行本文实验时需要确保安装了 "),o(d,{to:"/posts/envs/ros-env.html"},{default:a(()=>[s("ROS 环境安装")]),_:1}),s(" 一文中的指定环境。")])]),f,o(c,{id:"77",data:[{title:"终端 1"},{title:"终端 2"},{title:"终端 3"}]},{tab0:a(({title:e,value:p,isActive:t})=>[x]),tab1:a(({title:e,value:p,isActive:t})=>[N]),tab2:a(({title:e,value:p,isActive:t})=>[A]),_:1}),I,o(c,{id:"155",data:[{title:"终端 1"},{title:"终端 2"},{title:"终端 3"}]},{tab0:a(({title:e,value:p,isActive:t})=>[S]),tab1:a(({title:e,value:p,isActive:t})=>[w]),tab2:a(({title:e,value:p,isActive:t})=>[E]),_:1}),C,o(c,{id:"204",data:[{title:"终端 1"},{title:"终端 2"}]},{tab0:a(({title:e,value:p,isActive:t})=>[P]),tab1:a(({title:e,value:p,isActive:t})=>[T]),_:1})])}const q=r(b,[["render",R],["__file","ros-lab.html.vue"]]);export{q as default};
