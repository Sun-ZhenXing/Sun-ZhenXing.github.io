import{_ as d}from"./plugin-vue_export-helper-c27b6911.js";import{r as c,o as r,c as k,a as v,e as n,f as s,d as t,w as a,b as i}from"./app-d2020c50.js";const m={},b=n("p",null,"ROS 实验内容。",-1),_={class:"hint-container info"},g=n("p",{class:"hint-container-title"},"说明",-1),y={href:"https://gitee.com/sun-zhenxing/ros-lab",target:"_blank",rel:"noopener noreferrer"},h=i(`<h2 id="_1-自定义话题通信" tabindex="-1"><a class="header-anchor" href="#_1-自定义话题通信" aria-hidden="true">#</a> 1. 自定义话题通信</h2><p>创建一个名为 <code>learning01_ws</code> 的工作空间：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">mkdir</span> <span class="token parameter variable">-p</span> learning01_ws/src
...
`)])])],-1),N=i(`<p>使用下面的命令用于可视化查看当前 ROS 通信的逻辑图：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>rqt_graph
...
<span class="token function">catkin_install_python</span><span class="token punctuation">(</span>PROGRAMS scripts/demo03_param_del_p.py
  DESTINATION <span class="token punctuation">\${</span>CATKIN_PACKAGE_BIN_DESTINATION<span class="token punctuation">}</span>
<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>现在构建，确保没有错误即可运行。</p><p>利用 <code>rosparam list</code> 命令查看所有参数，利用 <code>rosparam get &lt;param&gt;</code> 命令获取指定参数。</p><p>下面创建三个终端，执行测试：</p>`,16),C=n("div",{class:"language-bash","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token comment"},"# 启动 ROS 核心进程，只需要启动一次"),s(`
roscore
...
`)])])],-1);function T(R,O){const l=c("ExternalLinkIcon"),u=c("RouterLink"),o=c("CodeTabs");return r(),k("div",null,[b,v(" more "),n("div",_,[g,n("p",null,[s("本文的源代码在 "),n("a",y,[s("Gitee"),t(l)]),s(" 上保存，在进行本文实验时需要确保安装了 "),t(u,{to:"/posts/envs/ros-env.html"},{default:a(()=>[s("ROS 环境安装")]),_:1}),s(" 一文中的指定环境。")])]),h,t(o,{id:"77",data:[{id:"终端 1"},{id:"终端 2"},{id:"终端 3"}]},{title0:a(({value:e,isActive:p})=>[s("终端 1")]),title1:a(({value:e,isActive:p})=>[s("终端 2")]),title2:a(({value:e,isActive:p})=>[s("终端 3")]),tab0:a(({value:e,isActive:p})=>[f]),tab1:a(({value:e,isActive:p})=>[x]),tab2:a(({value:e,isActive:p})=>[A]),_:1}),N,t(o,{id:"155",data:[{id:"终端 1"},{id:"终端 2"},{id:"终端 3"}]},{title0:a(({value:e,isActive:p})=>[s("终端 1")]),title1:a(({value:e,isActive:p})=>[s("终端 2")]),title2:a(({value:e,isActive:p})=>[s("终端 3")]),tab0:a(({value:e,isActive:p})=>[I]),tab1:a(({value:e,isActive:p})=>[S]),tab2:a(({value:e,isActive:p})=>[w]),_:1}),E,t(o,{id:"204",data:[{id:"终端 1"},{id:"终端 2"}]},{title0:a(({value:e,isActive:p})=>[s("终端 1")]),title1:a(({value:e,isActive:p})=>[s("终端 2")]),tab0:a(({value:e,isActive:p})=>[C]),tab1:a(({value:e,isActive:p})=>[P]),_:1})])}const q=d(m,[["render",T],["__file","ros-lab.html.vue"]]);export{q as default};
